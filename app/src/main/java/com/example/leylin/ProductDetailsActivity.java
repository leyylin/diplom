        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (state.equals("Order Placed") || state.equals("Order Shipped")){
                    Toast.makeText(ProductDetailsActivity.this,"Вы сможете добавить дополнительный товар, как только ваш заказ будет отправлен или подтвержден",Toast.LENGTH_LONG).show();
                }
                else
                {
                    addingToCartList();
