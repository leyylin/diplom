...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Итоговая цена = ₽ "+totalAmount,Toast.LENGTH_SHORT).show();
    ...
    private void Check() {
        if(TextUtils.isEmpty(nameEditText.getText().toString())){
            ...
            Toast.makeText(this,"Пожалуйста, укажите свой актуальный адрес.",Toast.LENGTH_SHORT).show();
        }
                ...
                if (task.isSuccessful()){
                    FirebaseDatabase.getInstance().getReference()
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        Toast.makeText(ConfirmFinalOrderActivity.this,"Ваш окончательный заказ был успешно размещен.",Toast.LENGTH_SHORT).show();
